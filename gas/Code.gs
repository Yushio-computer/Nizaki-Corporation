...
const CONFIG = {
  ...
  STAMP_KEYWORDS: {
    ...
    // ※LINE公式の応答メッセージには引換コード「KZ-MASHIN-30」を記載する(アプリのデリバリー画面で30%OFFとして受理される)
    ...
    // ※LINE公式の応答メッセージには引換コード「KZ-KAITAN-30」を記載する(アプリのデリバリー画面で30%OFFとして受理される)
    'KANZAKI_MYSTERY_CLEAR_2026': { courseId: 'kaitan_mystery', courseName: '【ミステリー制覇】消えた試運転列車の謎', reward: 'デリバリー1品30%OFF' }
  }
};
